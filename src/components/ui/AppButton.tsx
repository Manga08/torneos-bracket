...
const BUTTON_STYLES = {
  default: {
    primary: 'btn-primary',
    secondary: 'bg-surface-highlight border border-white/10 text-white hover:bg-surface-highlight/80', // Custom secondary for default
    ghost: 'btn-ghost',
...
export const AppButton = React.forwardRef<HTMLButtonElement, AppButtonProps>(
  ({ 
    ...
    const effectiveTheme = (theme && theme in BUTTON_STYLES) ? theme as keyof typeof BUTTON_STYLES : 'default';
    ...
    // Common classes
    const baseClasses = 'inline-flex items-center justify-center gap-2 transition-all duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed';
